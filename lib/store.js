...
function addReading({ material, color = null, shade, shadeSource = null, temp, airTemp = null, place = "", by = "", lat = null, lon = null }) {
  const payload = { material, color, shade, shadeSource, temp: Number(temp), airTemp: airTemp ? Number(airTemp) : null, place, by, lat, lon, group: getGroup() };
