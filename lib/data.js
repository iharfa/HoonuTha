// Science model + reference data for Hoonu Tha.
...
export const APP = {
  name: "Hoonu Tha",
  short: "Hoonu Tha",
  tagline: "Measure your island. Keep it cool.",
  theme: "#e0632f",
};
...
export const MATERIALS = [
  ...
  { id: "turf", label: "Artificial turf", icon: "🟩", family: "Play area", albedo: 0.12, colors: false, sunTemp: 64,
    about: "Fake plastic grass (used on futsal pitches). It looks green but has no water to cool itself, so it gets as hot as asphalt — far hotter than real grass." },
